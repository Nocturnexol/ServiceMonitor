...
$(function () {
    ...
    function a() {
		...
		n = 0;
        if ($(".page-tabs-content").width() < i && $(".page-tabs-content").width() != e)
            return !1;
        else if ($(".page-tabs-content").width() == e) {
            $(".page-tabs-content").animate({
                marginLeft: 0  + "px"
            },
		"fast")
    ...
    function n() {
        ...
        if ($(this).parent().parent().prev().hasClass("J_menuItem")) {
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var o = layer.load();
            $(".J_mainContent iframe:visible").load(function (data) {
                layer.close(o)
            }),
